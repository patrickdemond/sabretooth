...
-- Thu 03 Dec 2015 02:26:17 PM EST
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`recording` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_recording_participant_id` (`participant_id` ASC),
  INDEX `uq_participant_id_rank` (`participant_id` ASC, `rank` ASC),
  CONSTRAINT `fk_recording_id1`
    FOREIGN KEY (`participant_id`)
    REFERENCES `cenozo`.`participant` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
